...
import { createClient, emptyMcVersionsNet, listVersions, McVersionsNet } from './versions';

const client = createClient({ baseUrl: 'localhost:6969' });
...
export function App(): JSX.Element {
  ...
  useEffect(() => {
    client.list({}).then((x) => console.log(x.response.versions)).catch((e) => console.error(e));
  }, []);
